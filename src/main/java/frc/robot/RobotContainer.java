...
import frc.robot.commands.climbWithPov;
...
private final Joystick testJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    m_climb.setDefaultCommand(new climbWithPov( m_climb ) );
    ...
    m_chooser.addOption("AutoLeft", new AutoLeft( m_ballAcquisition, m_ballIndexer, m_ballShooter,  m_driveTrain, m_shifter ));
    m_chooser.addOption("AutoRight", new AutoRight( m_ballAcquisition, m_ballIndexer, m_ballShooter,  m_driveTrain, m_shifter ));
    m_chooser.addOption("AutoMiddle", new AutoMiddle( m_ballAcquisition, m_ballIndexer, m_ballShooter,  m_driveTrain, m_shifter ));
...
btnResetHood.whenPressed(new zeroHood( m_ballShooter ).withTimeout(8.0) ,false);
   // SmartDashboard.putData("btnResetHood",new zeroHood( m_ballShooter ).withTimeout(8.0) );
...
btnExtendSolenoid.whenPressed(new extendSolenoid( m_ballAcquisition ).withTimeout(5.0) ,true);
   // SmartDashboard.putData("btnExtendSolenoid",new extendSolenoid( m_ballAcquisition ).withTimeout(5.0) );
...
btnTurn2LimeLight.whenPressed(new turn2LimeLight( m_driveTrain ).withTimeout(2.0) ,true);
    SmartDashboard.putData("btnTurn2LimeLight",new turn2LimeLight( m_driveTrain ).withTimeout(2.0) );
...
btnShoot.whileHeld(new teleopAutoShootCMD( m_ballShooter ).withTimeout(10.0) ,true);
  ...
  //  SmartDashboard.putString("startingPosition","L");
  }
