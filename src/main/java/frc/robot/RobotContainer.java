...
// Create some buttons
final JoystickButton btnReverseAcquire = new JoystickButton(testJoystick, 4);        
btnReverseAcquire.whenHeld(new reverseAcquire( m_ballAcquisition ) ,true);
    SmartDashboard.putData("btnReverseAcquire",new reverseAcquire( m_ballAcquisition ) );

final JoystickButton btnUnDeployAcquisition = new JoystickButton(testJoystick, 3);        
btnUnDeployAcquisition.whenPressed(new undeployAcquisition( m_ballAcquisition ) ,true);
...
btnReverseBeltMotors.whileHeld(new reverseBeltMotors( m_ballIndexer ) ,true);
