...
private final Joystick testJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("idleBallShooter", new idleBallShooter( m_ballShooter ));
    SmartDashboard.putData("hoodDown", new hoodDown( m_ballShooter ));
    SmartDashboard.putData("hoodUp", new hoodUp( m_ballShooter ));
    SmartDashboard.putData("shiftUp", new shiftUp( m_driveTrain ));
    SmartDashboard.putData("shiftDown", new shiftDown( m_driveTrain ));
...
// Create some buttons
final JoystickButton btnMagazineDown = new JoystickButton(testJoystick, 8);        
btnMagazineDown.whileHeld(new runBelt(-.4, m_ballIndexer) ,true);
    SmartDashboard.putData("btnMagazineDown",new runBelt(-.4, m_ballIndexer) );

final JoystickButton btnMagazineUp = new JoystickButton(testJoystick, 8);        
btnMagazineUp.whileHeld(new runBelt(.4, m_ballIndexer) ,true);
    SmartDashboard.putData("btnMagazineUp",new runBelt(.4, m_ballIndexer) );

final JoystickButton btnShootModeOn = new JoystickButton(testJoystick, 8);        
...
final JoystickButton btnStop = new JoystickButton(testJoystick, 1);        
btnStop.whenReleased(new stopShootMotor( m_ballShooter ) ,true);
    SmartDashboard.putData("btnStop",new stopShootMotor( m_ballShooter ) );

final JoystickButton btnFire = new JoystickButton(testJoystick, 1);        
