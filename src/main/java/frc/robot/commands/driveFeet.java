...
private boolean ranOnce = false;
    ...
    public void end(boolean interrupted) {
        m_driveTrain.stop();
        m_driveTrain.motorConfigFalcon();
        m_driveTrain.getRightMotor().motionAcceleration = 1000; // (distance units per 100 ms) per second
        m_driveTrain.getRightMotor().motionCruiseVelocity = 4000; // distance units per 100 ms
    }
