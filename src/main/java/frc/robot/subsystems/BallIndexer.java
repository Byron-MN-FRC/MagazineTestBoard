...
gateSensor = new DigitalInput(7);
 addChild("gateSensor",gateSensor);
	...
	public void SetGateLoadInProgress(boolean value){ gateLoadInProgress = value; }

    private boolean magazineLoadInProgress;
    public boolean MagazineLoadInProgress(){ return magazineLoadInProgress; }
    public void SetMagazineLoadInProgress(boolean value){ magazineLoadInProgress = value; }
    ...
    public void periodic() {
		...
		SmartDashboard.putBoolean("Gate Sensor", ballAtGate());
		SmartDashboard.putBoolean("Top Sensor", ballAtTop());
	...
	private void moveBallToMagazine() {
		while (!ballAtBottom()) {
			gateMotor.set(.3);
		}
		gateMotor.stopMotor();
	...
	public void advanceBall() {
		...
		// Wait for ball to be moved out of sensor range
		while(!advanceBallComplete()) { continue; }
	}
