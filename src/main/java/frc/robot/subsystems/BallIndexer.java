...
gateSensor = new DigitalInput(7);
 addChild("gateSensor",gateSensor);
    ...
    public void periodic() {
		...
		// Ball present at gate?
		 if (ballAtGate()) {
		 	// Room in magazine?
		 	if (!isFull()) {
		 		// Move ball to magazine
		// 		moveBallToMagazine();
				SmartDashboard.putData("Indexer-RunAcquireMotor",new startGateMotor( this ) );
		// 		// Advance ball into magazine
		// 		advanceBall();
			} 
		}
	}
